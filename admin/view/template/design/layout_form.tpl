              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                        ...
                        <option value="content_menu" selected="selected"><?php echo "content_menu"; ?></option>
                        <?php } else { ?>
                        <option value="content_menu"><?php echo "content_menu"; ?></option>
                        <?php } ?>

                        <?php if ($layout_module['position'] == 'content_up') { ?>
                        <option value="content_up" selected="selected"><?php echo $text_content_up; ?></option>
                        <?php } else { ?>
                        <option value="content_up"><?php echo $text_content_up; ?></option>
                        <?php } ?>

                        <?php if ($layout_module['position'] == 'content_down') { ?>
                        <option value="content_down" selected="selected"><?php echo "content_down"; ?></option>
                        <?php } else { ?>
                        <option value="content_down"><?php echo "content_down"; ?></option>
                        <?php } ?>
...
function addModule() {
    ...
    html += '    <option value="content_menu"><?php echo "content_menu"; ?></option>';
    html += '    <option value="content_up"><?php echo $text_content_up; ?></option>';
    html += '    <option value="content_down"><?php echo "content_down"; ?></option>';
    html += '  </select></td>';
