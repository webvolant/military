...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
        ...
        $data['text_content_menu'] = $this->language->get('text_content_menu');
        $data['text_content_up'] = $this->language->get('text_content_up');
        $data['text_content_down'] = $this->language->get('text_content_down');
