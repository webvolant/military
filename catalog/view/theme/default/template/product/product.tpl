      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
              ...
              <?php $cur = strripos($price, '€');
                      if ( $cur == true ){ ?>
              :<span class="price-delivery"><?php echo substr($price,0, -1) - substr($tax,0, -1); echo '€'; ?></span>
              <?php } else { ?>
              :<span class="price-delivery"><?php echo substr($price,0, -1) - substr($tax,0, -1); echo substr($price, -1); ?></span>
              <?php } ?>
              <?php } ?>
